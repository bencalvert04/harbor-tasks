A few harbour tasks to acquaint myself with the harbour framework. 

Tasks were made in the following order:

1. **ssh-key-pair:** The walk through in the harbour docks.
